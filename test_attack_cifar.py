...
if __name__ == "__main__":
    ...
    parser.add_argument("-is", "--iteration_steps", type=int, default=1000, help="number of iteration")
    ...
    parser.add_argument("-ta", "--targeted", action='store_true', default=True,
    ...
    parser.add_argument("-ep", "--epi", type=float, default=1, help='epison hyperparameter')
